...
cp ${MODEL_PATH}/config/run.env.pei     ~/deepracer-on-the-spot-pei/custom-files/run.env
cp ${MODEL_PATH}/config/system.env.pei  ~/deepracer-on-the-spot-pei/custom-files/system.env