...
class MyRewardClass:
    ...
    def my_reward_function(self, params):
        ...
        #### projected_time(self.first_racingpoint_index, closest_index, steps, times_list)
...
myRewardObject = MyRewardClass() 

def reward_function(params):
    return myRewardObject.my_reward_function(params)
