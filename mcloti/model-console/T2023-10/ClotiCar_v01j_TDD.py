from ClotiCar_v01j_wip import CarControl
...
def test_Esta_En_La_Recta(waypoint, expected): 
    rta = CarControl.esta_en_la_recta(waypoint)
    try:
        assert rta == expected
    except AssertionError as e:
        print(f'Assertion fallo para esta_en_la_recta({waypoint}))')
        exit(1)

# Contrloes en OFF
test_Esta_En_La_Recta(16, True)
test_Esta_En_La_Recta(84, True)
test_Esta_En_La_Recta(12, False)
